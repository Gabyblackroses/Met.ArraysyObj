...
document.write('<h3>Cantidad de atenciones Dental</h3>');
document.write('<hr>');
...
document.write('<h3>Listado Pacientes</h3>');
document.write('<hr>');
radiologia.forEach(function (radiologia) {
    document.write (radiologia.paciente+"<br/>")
})

traumatologia.forEach(function (traumatologia) {
    document.write(traumatologia.paciente+"<br/>")
})

dental.forEach(function (dental) {
    document.write(dental.paciente+"<br/>")
})
    
document.write('<h3>Cambio Previsión</h3>');
document.write('<hr>');
